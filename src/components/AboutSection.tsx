...
const STORY_MEMBERS = [
  {
    ...
    src: "/p2.png",
    quote: "With an eye for emotion and a heart for storytelling, I believe every frame holds a memory waiting to be timeless art. Our vision at Alpha stories studio is to capture your legacy in its purest, most beautiful form.",
  },
  {
    name: "Alpha stories studio",
    designation: "Chengalpattu - 603 001",
    src: "/p1.jpeg",
    quote: "Turning Moments Into Timeless Art. We specialize in wedding photography, model shoots, candid portraits, maternity sessions, and 4K drone videography based in Chengalpattu.",
  },
];
